...
// import '../css/createnewtheater.css'
// const AddTheaters = () => {
//   const [theaterData, setTheaterData] = useState({ name: "", location: "", capacity: "" });
...
//     e.preventDefault();
//     console.log("Theater Data Submitted:", theaterData);
//     // Add API call for theater creation here
//   };
...
// const AddTheaters = () => {
//   const [theaterData, setTheaterData] = useState({ name: "", location: "", screen: "" });
...
//         setTheaterData({ name: "", location: "", screen: "" }); // Reset form
//       }
//     } catch (error) {
//       setErrorMessage(
